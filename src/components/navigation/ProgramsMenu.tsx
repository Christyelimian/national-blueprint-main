...
const thematicFocus = [
  ...
  { title: 'Delivery Track Record', description: 'Demonstrated execution capability', href: '/delivery-track-record' },
];

const programStatus = [
  { title: 'Strategic Development', count: '1 program', href: '/programs?status=strategic' },
  { title: 'Structured Initiative', count: '1 program', href: '/programs?status=structured' },
  { title: 'Implementation Phase', count: '1 program', href: '/programs?status=implementation' },
 ];
              ...
              {countryPrograms.map((program) => (
                ...
                >
                   <div className="flex items-center gap-3">
                     <span className="text-xl">{COUNTRY_CONFIGS[program.country as keyof typeof COUNTRY_CONFIGS]?.flag}</span>
                     <div>
